...
<div class="tab-content">
	...
	<div class="tab-pane  active" id="blockView">
		...
		$letestQuery="SELECT product_table.*,table_brand.brand_id,table_brand.brand_name,category_table.category_id,category_table.category_name
                  ...
                  WHERE product_table.product_brond='$cid'
	...
	<hr class="soft"/>
 			...
 			$paginationQuery="SELECT * FROM product_table WHERE product_table.product_brond='$cid' ";
 			...
 			if(mysqli_num_rows($runPagQuery)) {
               ...
               echo '<ul>';
 				for($i=1;$i<= $total_page;$i++) {
 					...
 					echo 	" <li><a class='$active' href='albrond.php?cid=".$cid."&page=$i'>".$i."</a></li> ";
 				}
 				echo '</ul>';
 			}
