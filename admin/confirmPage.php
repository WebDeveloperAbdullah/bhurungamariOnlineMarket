 ...
 ?>
            <div class="col-9">
 			...
 			$offset=($page-1) *$limet;
                  ...
                  $showCatQuery="SELECT * FROM table_order WHERE status='1' ORDER BY date  LIMIT {$offset},{$limet}";
                  ...
                  <thead>
                    ...
                    <th><?php 
                     ...
                     <th><a href="DeactiveOrder.php?activeId=<?php echo $gatId ?>" >UnConfirm</a></th>
 			...
 			if(mysqli_num_rows($runPagQuery)) {
               ...
               echo '<ul>';
 				for($i=1;$i<= $total_page;$i++) {
 					...
 					echo 	" <li><a class='$active' href='confirmPage.php?page=$i'>".$i."</a></li> ";
 				}
 				echo '</ul>';
 			}
