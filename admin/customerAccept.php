 ...
 ?>
            <div class="col-9">
            	<div class="min_conteant">
            		<h3>Customer Accept Order</h3>

                <a href="confirmPage.php" class="btn btn-success">Confirm</a>
                 <a href="orderView.php" class="btn btn-success">Order View</a>
 			...
 			$offset=($page-1) *$limet;
                  ...
                  $showCatQuery="SELECT * FROM table_order WHERE order_com='1' ORDER BY  date  LIMIT {$offset},{$limet}";
 			...
 			if(mysqli_num_rows($runPagQuery)) {
               ...
               echo '<ul>';
 				for($i=1;$i<= $total_page;$i++) {
 					...
 					echo 	" <li><a class='$active' href='customerAccept.php?page=$i'>".$i."</a></li> ";
 				}
 				echo '</ul>';
 			}
